...
public class Mapping<K, V> {
    ...
    public Map<String, ArrayList<String>> createMap() {
        map = new HashMap<>();
        addValue("Vorobyev", "Boris");
        addValue("Vorobyev", "Gleb");
        addValue("Korsunov", "Ivan");
        addValue("Korsunov", "Dmitry");
        addValue("Petuhov", "Vladimir");
        addValue("Farkhutdinov", "Azamat");
        addValue("Tramp", "Baiden");
        return map;
    }
