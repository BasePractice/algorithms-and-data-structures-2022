...
public class ExpressionParser {
    public double tripleexpressionparse(String string, int... ints) {
        ...
        for (int i = 0; i < string.length(); i++) {
            ...
            if (!p1.matcher(a).matches() & !p2.matcher(a).matches()
                    & !p3.matcher(a).matches() & !p4.matcher(a).matches() & !p5.matcher(a).matches()
                    & !p6.matcher(a).matches() & !p7.matcher(a).matches() & !p8.matcher(a).matches()
                    & !p9.matcher(a).matches()) {
