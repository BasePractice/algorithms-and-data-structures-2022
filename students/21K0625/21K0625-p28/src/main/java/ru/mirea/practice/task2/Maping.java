...
public class Maping<K, V> {
    ...
    public Map<String, ArrayList<String>> createMap() {
        map = new HashMap<>();
        addValue("Осипов", "Андрей");
        addValue("Зыков", "Борис");
        addValue("Джеки", "Чан");
        addValue("Волков", "Макс");
        addValue("Пуджев", "Дмитрий");
        addValue("Сларк", "Дмитрий");
        addValue("Осипов", "Елисей");
        addValue("Парадеев", "Женя");
        addValue("Куэртов", "Зина");
        addValue("Горилла", "Ваня");
        return map;
    }
